          ...
          <div className="prose prose-orange max-w-none">
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 text-sm">1</div>
                Introduction
              </h2>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 text-sm">2</div>
                Consent
              </h2>
              <p className="text-gray-600 leading-relaxed">
              ...
              <div className="p-8 bg-gray-50 rounded-[2rem] border border-gray-100">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-sm text-gray-500">You have the right to request copies of your personal data.</p>
                  </div>
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                  ...
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    ...
                    <p className="text-sm text-gray-500">You have the right to request that we erase your personal data, under certain conditions.</p>
                  </div>
                  <div className="bg-white p-5 rounded-2xl shadow-sm border border-gray-100">
                    <h4 className="font-bold text-gray-900 mb-2">Right to Object</h4>
                    <p className="text-sm text-gray-500">You have the right to object to our processing of your personal data.</p>
                  </div>
                </div>
              </div>
            </section>
            ...
            <section className="mb-12">
              <h2 className="text-2xl font-bold text-gray-900 mb-4 flex items-center gap-3">
                <div className="w-8 h-8 rounded-lg bg-gray-100 flex items-center justify-center text-gray-600 text-sm">4</div>

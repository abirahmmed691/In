...
export default function Features() {
  ...
  return (
    <section id="surveys" className="py-24 bg-white relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {features.map((feature, index) => (
            <motion.div
              ...
              className="bg-white rounded-3xl p-8 shadow-sm border border-gray-100 hover:shadow-xl hover:shadow-orange-500/5 hover:border-orange-100 hover:-translate-y-1 transition-all duration-300 group"
            >

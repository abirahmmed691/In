...
export default function HowItWorks() {
  ...
  return (
    <section id="how-it-works" className="py-24 bg-theme-bg relative overflow-hidden">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {steps.map((step, index) => (
            <motion.div
              ...
              className="relative group bg-theme-surface rounded-3xl p-8 shadow-sm border border-theme-border hover:shadow-xl hover:shadow-orange-500/5 hover:border-orange-100 transition-all duration-300"
            >
              <div className="relative z-10 flex flex-col items-center text-center">
                ...
                <div className="w-8 h-8 rounded-full bg-theme-bg flex items-center justify-center text-sm font-bold text-theme-text-muted opacity-60 mb-4 group-hover:bg-primary group-hover:text-white transition-colors">
                  {step.id}
                </div>
                <h3 className="text-xl font-bold text-theme-text mb-3">{step.title}</h3>

...
import { ArrowLeft, UserPlus, UserMinus, ShieldAlert, ShieldCheck, X, User } from 'lucide-react';
...
export default function AdminUserDetailTab() {
  ...
  const [modalState, setModalState] = useState<'credit' | 'chargeback' | null>(null);
            ...
            >
              <div className="flex items-center justify-between mb-6">
                <h3 className="text-xl font-bold text-gray-900">
                  {modalState === 'credit' ? 'Add Balance (Credit)' : 'Deduct Balance (Chargeback)'}
                </h3>
                <button onClick={() => setModalState(null)} className="p-2 text-gray-400 hover:bg-gray-100 rounded-full">
                  <X className="w-5 h-5" />
                </button>
              </div>

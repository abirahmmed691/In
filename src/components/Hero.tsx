...
export default function Hero() {
  ...
  return (
    <section id="home" className="relative min-h-screen pt-32 pb-20 md:pt-40 md:pb-32 overflow-hidden bg-white selection:bg-primary/20 selection:text-primary">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-8 items-center pt-8">
          ...
          <div className="max-w-2xl">
            ...
            <motion.h1
              ...
              className="text-5xl sm:text-6xl lg:text-7xl font-extrabold text-gray-900 tracking-tight leading-[1.05] mb-6 font-display"
            >
              Get Paid For <br />
            ...
            >
              ...
              <a 
                href="#how-it-works"
                className="inline-flex items-center justify-center px-8 py-4 rounded-full bg-white text-gray-700 font-semibold text-lg border border-gray-200 shadow-sm hover:border-gray-300 hover:bg-gray-50 hover:-translate-y-1 active:scale-95 transition-all duration-300"
              >
                How It Works
              </a>
            </motion.div>
            ...
            <motion.div
              ...
              className="grid grid-cols-2 md:grid-cols-3 gap-6 pt-8 border-t border-gray-100"
            >
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5 mb-1">
                  <Star className="w-5 h-5 text-yellow-400 fill-yellow-400" />
                  <span className="font-bold text-gray-900 text-xl font-display">4.9</span>
                </div>
                <span className="text-sm font-medium text-gray-500">App Store Rating</span>
              </div>
              
              <div className="flex flex-col">
                <div className="flex items-center gap-1.5 mb-1">
                  <Users className="w-5 h-5 text-primary" />
                  <span className="font-bold text-gray-900 text-xl font-display">5k+</span>
                </div>
              ...
              <div className="flex flex-col col-span-2 md:col-span-1">
                <div className="flex items-center gap-1.5 mb-1">
                  ...
                  <span className="font-bold text-gray-900 text-xl font-display">$250k+</span>
                </div>
                <span className="text-sm font-medium text-gray-500">Paid to Users</span>
              </div>
            </motion.div>
          </div>
            ...
            <div className="relative flex justify-center">
              ...
              >
                <motion.div
                  ...
                  className="bg-white/70 backdrop-blur-xl border border-white p-4 rounded-2xl shadow-2xl shadow-orange-500/10 w-64 transform rotate-[4deg]"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">Payment Sent</p>
                      <p className="text-sm font-bold text-gray-900">+$25.00 to PayPal</p>
                    </div>
                  </div>
                </motion.div>
              </motion.div>
              ...
              >
                <motion.div
                  ...
                  className="bg-white/70 backdrop-blur-xl border border-white p-4 rounded-2xl shadow-2xl shadow-orange-500/10 w-[270px] transform -rotate-[3deg]"
                >
                  <div className="flex items-center gap-3">
                    ...
                    <div className="flex-1">
                      <p className="text-xs font-semibold text-gray-500 uppercase tracking-wider">New Survey</p>
                      <p className="text-sm font-bold text-gray-900 line-clamp-1">Tech Habits 2024</p>
                    </div>
              ...
              <motion.div
                ...
                className="relative z-20 w-[320px] h-[640px] bg-gray-900 rounded-[3.5rem] p-3.5 shadow-2xl shadow-gray-900/30 border border-gray-800 ring-4 ring-gray-900/5"
              >
                {/* Screen */}
                <div className="w-full h-full bg-gray-50 rounded-[2.5rem] overflow-hidden relative flex flex-col">
                  ...
                  {/* App Content */}
                  <div className="flex-1 p-6 pt-12 overflow-y-auto hide-scrollbar flex flex-col gap-6 bg-gray-50">
                    {/* App Header (Balance) */}
                    <div className="text-center bg-white p-5 rounded-3xl shadow-sm border border-gray-100 mt-2">
                      <p className="text-sm text-gray-500 font-medium mb-1">Available Balance</p>
                      <h2 className="text-4xl font-display font-bold text-gray-900">$124.50</h2>
                      <button className="mt-4 w-full bg-gray-900 text-white text-sm font-medium py-2.5 rounded-xl hover:bg-gray-800 transition-colors">
                        Cash Out
                      </button>
                    </div>
                    ...
                    <div className="bg-orange-50 border border-orange-100 rounded-2xl p-4">
                      <div className="flex justify-between items-end mb-2">
                        <div>
                          ...
                          <p className="text-sm font-medium text-gray-800">Complete 3 surveys</p>
                        </div>
                    ...
                    <div>
                      <div className="flex justify-between items-center mb-3">
                        <h3 className="font-bold text-gray-900 text-sm">Available Surveys</h3>
                      ...
                      <div className="space-y-3">
                        {/* Survey Item 1 */}
                        <div className="bg-white p-3.5 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-3 cursor-pointer hover:border-orange-200 transition-colors">
                          <div className="w-10 h-10 rounded-xl bg-blue-50 flex items-center justify-center shrink-0">
                            <span className="text-blue-600 font-bold text-sm">N</span>
                          </div>
                          <div className="flex-1">
                            <h4 className="text-sm font-bold text-gray-900">Consumer Habits</h4>
                            <p className="text-xs text-gray-500">15 mins • Brand Study</p>
                          </div>
                          <div className="text-right">
                        ...
                        <div className="bg-white p-3.5 rounded-2xl shadow-sm border border-gray-100 flex items-center gap-3 cursor-pointer hover:border-orange-200 transition-colors">
                          ...
                          <div className="flex-1">
                            <h4 className="text-sm font-bold text-gray-900">Music Streaming</h4>
                            <p className="text-xs text-gray-500">10 mins • Entertainment</p>
                          </div>
                          <div className="text-right">
                  ...
                  {/* Mockup Tab Bar */}
                  <div className="bg-white border-t border-gray-100 p-4 pb-6 flex justify-around items-center rounded-b-[2.5rem]">

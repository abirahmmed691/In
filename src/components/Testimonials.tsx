  ...
  return (
    <div className="flex flex-col gap-3 mb-6">
      <div className="flex items-center gap-2">
        ...
        <span className="text-sm font-black text-theme-text tracking-tight">{rating}</span>
      </div>
      <div className="flex items-center gap-2">
        <div className="h-px flex-1 bg-theme-surface-hover md:hidden" />
        <span className="text-[10px] font-black text-theme-text-muted opacity-60 uppercase tracking-[0.15em] shrink-0">
          Review from {date}
        </span>
        <div className="h-px flex-1 bg-theme-surface-hover hidden md:block" />
      </div>
    </div>
  );
}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-16 px-4">
          ...
          <motion.h2
            ...
            className="text-4xl md:text-5xl font-black text-theme-text font-display tracking-tight mb-4"
          >
          ...
          <motion.p
            ...
            className="text-lg text-theme-text-muted font-medium tracking-tight"
          >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testimonial, index) => (
            <motion.div
              ...
              className="bg-theme-surface rounded-[3rem] p-8 shadow-sm border border-theme-border hover:shadow-2xl hover:shadow-[#00b67a10] hover:border-[#00b67a20] transition-all duration-500 group relative flex flex-col"
            >
              ...
              <p className="text-theme-text leading-relaxed font-bold text-lg mb-8 relative z-10 flex-1">
                "{testimonial.text}"
              </p>

              <div className="flex items-center gap-4 border-t border-theme-border pt-6">
                <div className="relative shrink-0">
                  ...
                  <div className="absolute -bottom-0.5 -right-0.5 w-4 h-4 bg-[#00b67a] border-2 border-white rounded-full shadow-sm flex items-center justify-center">
                    <div className="w-1.5 h-1.5 bg-theme-surface rounded-full" />
                  </div>
                </div>
                <div className="flex flex-col justify-center">
                  <h4 className="font-black text-theme-text text-base tracking-tight leading-none mb-1">{testimonial.name}</h4>

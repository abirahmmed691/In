        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-20">
          {payoutMethods.map((method, index) => (
            <motion.div
              ...
              className="bg-theme-surface/5 backdrop-blur-md border border-white/10 rounded-[2rem] p-6 flex flex-col items-center justify-center group hover:bg-theme-surface/10 hover:border-white/20 transition-all duration-300"
            >
              <div className="w-14 h-14 rounded-2xl bg-theme-surface flex items-center justify-center mb-4 group-hover:scale-110 transition-transform shadow-lg shadow-black/20 overflow-hidden p-3">
                <img 
                  src={method.logo} 
                  alt={method.name} 
